...
export const fetchPostsSuccess = (posts: Post[]) => ({type: PostActions.POSTS_SUCCESS, posts})
export const fetchPostsFailure = (error: Error) => ({type: PostActions.POSTS_FAILURE, error})
